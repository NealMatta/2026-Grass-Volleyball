...
## Nets — the critical path

**Two courts, two nets, and only two teams have them.**
...
**Neal brings:**
- Cones or lines to mark both courts
- Printed schedule + paper score sheets, one per court, and pens
- A ball for each court
- First aid kit
- Trash bags
...
later — don't hold up the schedule over it.
...
## Open questions Neal still needs to sort

- [ ] **Confirm both nets** with Michael and Grant, and find a third as backup
