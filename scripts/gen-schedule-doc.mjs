...
w(`Games to **${schedule.gameRules.pool.to}**, win by ${schedule.gameRules.pool.winBy}, ` +
  `cap ${schedule.gameRules.pool.cap}. **Hard ${schedule.gameRules.pool.hardMinutes}-minute limit — ` +
  'at time, whoever leads wins.**');
w();
...
w(`Games to **${schedule.gameRules.bracket.to}**, win by ${schedule.gameRules.bracket.winBy}, ` +
  `cap ${schedule.gameRules.bracket.cap}. Hard ${schedule.gameRules.bracket.hardMinutes}-minute limit.`);
w();
...
const endMins = toMinutes(lastSlot.time) + schedule.gameRules.bracket.hardMinutes;
